...
public class AnnaUniversityTestTestNG {
...
//		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	...
	AssertJUnit.assertEquals("Institute For Ocean Management - Anna University offers M.Tech in Coastal Management. ENVIS Center for Coastal Zone Management and Coastal Shelterbelts",driver.getTitle());
...
//	wait.until(ExpectedConditions.titleContains(":: IOM - Institute For Ocean Management -  Anna University ::"));
	AssertJUnit.assertEquals(":: IOM - Institute For Ocean Management - Anna University ::",driver.getTitle());
